...
enum riscv_insn_class
{
  ...
  INSN_CLASS_ZBF,
  INSN_CLASS_ZBM,
  INSN_CLASS_ZBP_OR_ZBM_OR_ZKB,
  INSN_CLASS_ZBR,
  INSN_CLASS_ZBT,
  INSN_CLASS_ZBP_OR_ZBE_OR_ZBF_OR_ZKB,
  INSN_CLASS_ZBP_OR_ZBE_OR_ZBF_OR_ZBM_OR_ZKB,
  INSN_CLASS_ZKG,
  INSN_CLASS_ZKB,
  INSN_CLASS_ZKR,
  INSN_CLASS_ZKNE,
  ...
  INSN_CLASS_ZKSED,
  INSN_CLASS_ZKSH,
  INSN_CLASS_ZBB_OR_ZBP_OR_ZKB,
  INSN_CLASS_ZBB_OR_ZKB,
  INSN_CLASS_ZBC_OR_ZKB,
  INSN_CLASS_ZBP_OR_ZKB,
};
