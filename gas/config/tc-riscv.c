...
riscv_multi_subset_supports (enum riscv_insn_class insn_class)
{
  switch (insn_class)
    ...
    case INSN_CLASS_ZBB_OR_ZBP_OR_ZKB:
      return (riscv_subset_supports ("zbb") || riscv_subset_supports ("zbp") || riscv_subset_supports("zkb"));
    case INSN_CLASS_ZBS_OR_ZBE:
      return (riscv_subset_supports ("zbs") || riscv_subset_supports ("zbe"));
    case INSN_CLASS_ZBP_OR_ZBM_OR_ZKB:
      return (riscv_subset_supports ("zbp") || riscv_subset_supports ("zbm") || riscv_subset_supports ("zkb"));
    case INSN_CLASS_ZBP_OR_ZBE_OR_ZBF_OR_ZKB:
      return (riscv_subset_supports ("zbp") || riscv_subset_supports ("zbe") || riscv_subset_supports ("zbf") || riscv_subset_supports ("zkb"));
    case INSN_CLASS_ZBP_OR_ZBE_OR_ZBF_OR_ZBM_OR_ZKB:
      return (riscv_subset_supports ("zbp") || riscv_subset_supports ("zbe") || riscv_subset_supports ("zbf") || riscv_subset_supports ("zbm") || riscv_subset_supports ("zkb"));
    ...
    case INSN_CLASS_ZBB_OR_ZKB:
      return (riscv_subset_supports ("zbb") || riscv_subset_supports ("zkb"));
    case INSN_CLASS_ZBP_OR_ZKB:
      return (riscv_subset_supports ("zbp") || riscv_subset_supports ("zkb"));
    case INSN_CLASS_ZBC_OR_ZKB:
      return (riscv_subset_supports ("zbc") || riscv_subset_supports ("zkb"));
